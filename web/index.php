...
<hr>
 <thead>
	<tr>
	    <a target="_blank" href="" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-thumbs-up"></span>本网站使用方法</a>
		<a target="_blank" href="/vip7/ff.html" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-thumbs-up"></span>磁力链使用方法</a>
		...
		<a target="_blank" href="/vip7/jiexi.html" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-thumbs-up"></span>解析失败解决方法</a>
	</tr>
 </thead>
 <table class="table table-bordered">
  <tbody>
	...
	<option value="http://y.mt2t.com/lines?url="  style="color:red">1号通用接口👍</option>
	<option value="http://jx.aeidu.cn/index405.php?url=" style="color:red">2号通用接口👍</option>
